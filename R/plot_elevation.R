...
#' @param box_color Character string specifying the color for the box (default: "darkgrey").
#' @param box_background Character string specifying the background color for the box (default: "#f8f8f6").
#'
...
plot_elevation <- function(origin = "utrecht, netherlands",
